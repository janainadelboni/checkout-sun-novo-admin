...
const rastreamentoData: Record<string, { label: string; quantidade: number; cor: string }[]> = {
  ...
  Medium: [{ label: 'cpc', quantidade: 6000, cor: '#1890FF' }, { label: 'organic', quantidade: 4000, cor: 'var(--ant-color-success)' }],
  Campaign: [{ label: 'black_friday', quantidade: 8000, cor: '#722ED1' }, { label: 'launch_2025', quantidade: 2000, cor: 'var(--ant-color-warning)' }],
      ...
      <div className="flex gap-6">
        <div className="flex flex-col items-center gap-3 shrink-0">
          <PieChart segments={[
            ...
            { percent: 35, color: 'var(--ant-color-warning)', label: 'Não rastreável' },
          ]} />
          <div className="flex flex-col gap-1">
            {[{ label: 'Rastreável', color: '#1890FF' }, { label: 'Não rastreável', color: 'var(--ant-color-warning)' }].map((l) => (
